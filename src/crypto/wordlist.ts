// BIP39 English wordlist (2048 words), space-separated.
// https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
export const WORDLIST_STR =
  ...
  "arena argue arm armor army around arrange arrest arrive arrow art artifact artist artwork " +
  "ask aspect assault asset assist assume asthma athlete atom attack attend attitude attract " +
  "auction audit august aunt author auto autumn average avocado avoid awake aware awesome " +
  "awful awkward axis baby bachelor bacon badge bag balance balcony ball bamboo banana " +
  "banner bar barely bargain barrel base basic basket battle beach bean beauty because " +
  "become beef before begin behave behind believe below belt bench benefit best betray " +
  "better beyond bicycle bid bike bind biology bird birth bitter black blade blame blanket " +
  "blast bleak bless blind blood blossom blouse blue blur blush board boat body bomb " +
  ...
  "bundle bunker burden burger burst bus business busy butter buyer cabin cable cactus " +
  "cage cake call calm camera camp can canal cancel candy cannon canoe canvas canyon " +
  "capable capital captain car carbon card cargo carpet carry cart case cash casino " +
  "castle casual cat cattle caught cause cave ceiling celery cement census century " +
  "ceremony certain chair chalk champion change chaos chapter charge chase chat cheap " +
  "check cheek cheese chef cherry chest chicken chief child chimney choice choose " +
  "chronic chuckle chunk churn cigar cinnamon circle citizen city civil claim clap " +
  "clarify clasp class clean clerk click client cliff climb clinic clip clock clogs " +
  "close cloth cloud clown club clump cluster clutch coach coast coconut code coffee " +
  ...
  "crew cricket crime crisp critic crop cross crouch crowd crucial cruel cruise crumble " +
  "crunch crush cry crystal cube culture cup cupboard curious current curtain curve " +
  "cushion custom cute cycle dad damage damp dance danger daring dash date daughter " +
  ...
  "entire entry envelope episode equal equip era erase erosion error erupt escape " +
  "essence estate eternal ethics evidence evil evoke evolve exact example exceed " +
  "exchange excite exclude excuse execute exercise exhibit exile exist exit exotic " +
  "expand expect expire explain expose extend extra eye eyebrow fabric face faculty " +
  "fade faint faith fall false fame family famous fan fancy fantasy farm fashion fat " +
  "fatal father fatigue fault favorite feature february federal fee feed feel female " +
  "fence festival fetch fever few fiber fiction field figure file film filter final " +
  "find fine finger finish fire firm first fiscal fish fit fitness fix flag flame " +
  "flash flat flavor flee flight flip float flock floor flower fluid flush fly foam " +
  "focus fog foil fold follow food foot force foreign forest forget fork fortune " +
  "forum forward fossil foster found fox fragile frame frequent fresh friend fringe " +
  "frog front frost frown frozen fruit fuel fun funny furnace fury future gadget " +
  "gain galaxy gallery game gap garage garbage garden garlic garment gas gasp gate " +
  ...
  "gown grab grace grain grand grant grape graph grasp grass gravity great green " +
  "greet grey grid grief grill grip grocery group grow grunt guard guess guide guilt " +
  "guitar gun gym habit hair half hammer hamster hand happy harbor hard harsh harvest " +
  ...
  "hollow home honey hood hope horn horror horse hospital host hotel hour hover hub " +
  "huge human humble humor hundred hungry hunt hurdle hurry hurt husband hybrid ice " +
  ...
  "invest invite iron island isolate issue item ivory jacket job join joke journey " +
  "joy judge juice jump jungle junior junk just kangaroo keen keep ketchup key kick " +
  "kid kingdom kitchen kite kitten kiwi knee knife knock know lab label labor ladder " +
  "lady lake lamp language laptop large later latin laugh laundry lava law lawn lawsuit " +
  "layer lazy leader leaf learn leave lecture left leg legal legend leisure lemon lend " +
  ...
  "local lock logic lonely long loop lottery loud lounge love loyal lucky luggage " +
  "lumber lunar lunch luxury lyric machine mad magic magnet maid mail main major " +
  ...
  "milk million mimic mind mineral minimum minor minute miracle mirror misery miss " +
  ...
  "noble noise nominee noodle normal nose notable note nothing notice novel now " +
  "nuclear number nurse nut oak obey object obscure observe obtain obvious occur " +
  "ocean october odor off offer office often oil okay old olive olympic omit once " +
  "one onion online only open opera opinion oppose option orange orbit orchard order " +
  ...
  "patient patrol pattern pause pave payment peace peanut peasant peer penalty pencil " +
  ...
  "profit program project property protect prove provide public pudding pull pulp " +
  "pulse pumpkin punch pupil puppy purchase purity purpose purse push put puzzle " +
  "pyramid quality quantum quarter question quick quit quiz quota rabbit race rack " +
  "radar radio rail rain raise rally ramp ranch random range rapid rare rate rather " +
  ...
  "retreat return reunion reveal review reward rhythm rib ribbon rice rich ride " +
  "ridge rifle right rigid ring riot ripple risk ritual rival river road roast " +
  "robot robust rocket romance roof rookie room rose rotate rough round route royal " +
  "rubber rude rug rule run rural sad saddle sadness safe sail salad salmon salon " +
  "salt same sample sand satisfy satoshi sauce sausage save say scale scan scare " +
  ...
  "self seminar senior sense sentence series service session settle setup seven " +
  "shadow shaft shallow share shed shell sheriff shield shift shine ship shiver shock " +
  "shoe shoot shop short shoulder shovel shrimp shy sibling sick side siege sight " +
  "sign silent silk silly silver similar simple since sing siren sister situate six " +
  "size skate sketch ski skill skin skirt skull slab slam sleep slender slice slide " +
  ...
  "spatial speak special speed spell spend sphere spice spider spike spin spirit " +
  "split spokesperson sport spot spray spread spring spy square squeeze squirrel stable " +
  "stadium staff stage stairs stamp stand start state stay steak steel step stereo " +
  ...
  "sudden suffer sugar suggest suit sun sunny sunset supper supply support sure " +
  "surface surge surprise surround survey suspect sustain swallow swamp swap swarm " +
  "swear sweet swift swim swing sword symbol symptom syrup system table tackle tag " +
  "tail talent talk tank tape target task taste tattoo taxi teach team tell ten " +
  "tenant tennis tent term test text thank that theme then theory there they thing " +
  "this thought three thrive throw thumb ticket tide tiger tilt timber time tiny " +
  ...
  "toss total tourist toward tower town toy track trade traffic tragic train transfer " +
  "trap trash travel tray treat tree trend trial tribe trick trigger trim trip trophy " +
  "tropical trouble truck true truly trumpet trust truth try tube tuition tumble tuna " +
  "tunnel turkey turn turtle twelve twenty twice twin twist two type typical ugly " +
  "umbrella unable unaware uncle uncover understand unit universe unknown unlock until " +
  "unusual unveil update upgrade uphold upon upper upset urban urge usage use used " +
  ...
  "very vessel veteran viable vibrant vicious video view village vintage violin virtual " +
  "virus visa visit visual vital vivid vocal voice volcano volume vote voyage wage " +
  ...
  "whale what wheat wheel when where whip whisper wide width wife wild will win window " +
